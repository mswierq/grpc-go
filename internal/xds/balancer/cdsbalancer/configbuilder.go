...
// priorityConfig is config for one priority level (leaf cluster). For
// example, if an aggregate cluster has an EDS and a DNS leaf cluster, the
// priority list will be [priorityConfig{EDS}, priorityConfig{DNS}].
//
